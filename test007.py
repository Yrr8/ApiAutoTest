...
class Alipay:
    def zhifu(self,data):
        ...
        # 接口参数："OrderId":"23498735332","Amount":129.5,"Type":"支付宝"
...
class TestMock:
    def test_alipay(self):
        ...
        aliPay.zhifu = mock.Mock(returen_value={"code":200,"msg":"支付成功"})
        # 调用zhifu接口
        data = {"OrderId":"23498735332","Amount":129.5,"Type":"支付宝"}
        r = aliPay.zhifu(data)
        print(r)