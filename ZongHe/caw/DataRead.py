...
def readyaml(filePath):
    ...
    with open(real_path, "r", encoding="utf-8") as f:  # 打开文件
        content = yaml.load(f, Loader=yaml.FullLoader)  # 读取文件内容，放到content变量中
        return content


# 测试代码，用完可以删除
if __name__ == '__main__':
    # 预期返回D:\workspace\learnpytest\
    print(getProjectPath())
    # 预期返回http://jy001:8081/
    print(readini("ZongHe/data_env/env.ini", "url"))
    print(readini("ZongHe/data_env/env.ini", "db"))
    print(readyaml("ZongHe/data_case/register_fial.yaml"))
